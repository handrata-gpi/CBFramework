...
Pod::Spec.new do |s|
  s.name             = 'CBFramework'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CBFramework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/handrata.febrianto/CBFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'handrata.febrianto' => 'handrata.febrianto@cashbac.com' }
  s.source           = { :git => 'https://github.com/handrata.febrianto/CBFramework.git', :tag => s.version.to_s }
